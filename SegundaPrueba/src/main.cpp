...
const char* ssid = "ARRIS-A222";    //Nombre de la red wifi
const char* password = "104BCCAF9A08FEC2";    //password de la red
...
//  EntAna=analogRead(A0);
  ...
  if (now - lastMsg > 2000) {
    lastMsg = now;
    ++value;
    snprintf (msg, 75, "data from Tibu2 #%ld", EntTim);
